...
import com.project.helpdesksystem.model.Order;
import com.project.helpdesksystem.repository.OrderRepository;
...
public class OrderController {
	...
	public ArrayList getAllEmployeeFields() {
		 Query q = entityManager.createQuery("SELECT cust, ord from orders ord, customer cust WHERE customer_id = order_customer_id ORDER  BY order_id DESC");
		 ...
		 for ( Object[] row : sell ) {
			  ...
			  HashMap<String, String> results = new HashMap();
			    ...
			    results.put("order_from_date",order_details.getOrder_from_date());
			    results.put("order_to_date",order_details.getOrder_to_date());
			    results.put("order_total_days",order_details.getOrder_total_days());
